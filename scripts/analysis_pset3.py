...
def result_analysis():
    ...
    for task in tasks:
        ...
        lookup_only_results = pd.read_csv(f"results/results_bm_03/16_decent_results/{full_task_name}_ops_2M_0.000000rq_0.500000nl_0.000000i_results_table.csv")
        insert_lookup_results = pd.read_csv(f"results/results_bm_03/16_decent_results/{full_task_name}_ops_2M_0.000000rq_0.500000nl_0.500000i_0m_results_table.csv")
        insert_lookup_mix_1_results = pd.read_csv(f"results/results_bm_03/16_decent_results/{full_task_name}_ops_2M_0.000000rq_0.500000nl_0.100000i_0m_mix_results_table.csv")
        insert_lookup_mix_2_results = pd.read_csv(f"results/results_bm_03/16_decent_results/{full_task_name}_ops_2M_0.000000rq_0.500000nl_0.900000i_0m_mix_results_table.csv")
